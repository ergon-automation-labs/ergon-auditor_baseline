defmodule BotArmyAuditorBaseline.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyAuditorBaseline.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_auditor_baseline.command.example" in triggers
    end
  end
