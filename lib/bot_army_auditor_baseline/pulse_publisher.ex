defmodule BotArmyAuditorBaseline.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Baseline Bot.
  ...
  2. **`bot.auditor_baseline.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "auditor_baseline"
  @envelope_source "bot_army_auditor_baseline"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Baseline Bot pulse publisher")
