defmodule BotArmyAuditorBaseline.Application do
  @moduledoc """
  Baseline Bot application supervisor.
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: BotArmyAuditorBaseline.Supervisor]
    Supervisor.start_link(children, opts)
  end

  # No Repo module yet: DB wiring (repo module, config, migrations) lands with
  # the measurement-schema implementation. Starting the nonexistent
  # BotArmyAuditorBaseline.Repo here crash-looped the supervisor at boot.
  ...
  defp maybe_add_pulse_publisher(children) do
    if @env == :test do
      ...
      [{BotArmyAuditorBaseline.PulsePublisher, []} | children]
    end
  end

  defp maybe_add_consumer(children) do
    if @env == :test, do: children, else: [{BotArmyAuditorBaseline.NATS.Consumer, []} | children]
  end
