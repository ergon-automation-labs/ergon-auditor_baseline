defmodule BotArmyAuditorBaseline.Skills.Example do
  @moduledoc """
  Example skill for Baseline Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_auditor_baseline.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_auditor_baseline.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_auditor_baseline/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_auditor_baseline.command.example"
    ]
  end
