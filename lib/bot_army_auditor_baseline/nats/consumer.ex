defmodule BotArmyAuditorBaseline.NATS.Consumer do
  @moduledoc """
  NATS message consumer for auditor_baseline.
  ...
  def handle_continue(:connect, state) do
    case GenServer.call(BotArmyLibraryRuntime.NATS.Connection, :get_connection, 5000) do
      {:ok, conn} ->
        ...
        BotArmyLibraryRuntime.Registry.register("auditor_baseline", @subjects, @version)
