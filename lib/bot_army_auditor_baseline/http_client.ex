defmodule BotArmyAuditorBaseline.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyAuditorBaseline.HTTPClient.Req)
...
defmodule BotArmyAuditorBaseline.HTTPClient.Req do
  @moduledoc """
  Real HTTP client implementation using the Req library.
  """

  @behaviour BotArmyAuditorBaseline.HTTPClient
